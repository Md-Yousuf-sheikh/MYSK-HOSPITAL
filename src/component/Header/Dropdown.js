...
const Dropdown = ({ isOpen, toggle }) => {
    ...
    return (
        ...
        >
            ...
            <Link className="p-4 hover:text-white" to="/services">
                Service
            </Link>
            ...
            <span className="mx-2 py-3 ">
                {
                    user.email ? <buttn onClick={logOut} className=" inline-block mx-2"><svg className="text-blue-400 items-center inline-block w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" strokeLinejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1"></path></svg></buttn>
